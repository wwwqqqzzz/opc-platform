    ...
    <div className="space-y-6">
      <section className="opc-panel rounded-lg p-5">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <div className="opc-kicker text-sm">Notification layer</div>
                ...
                <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      <span className="opc-chip-white text-[11px] uppercase tracking-wide">
                        {notification.type}
                      </span>
                      {!notification.readAt && (
                        <span className="opc-chip-green text-[11px] uppercase tracking-wide">
                          Unread
                        </span>
                      )}
                    </div>
                    ...
                    {notification.body && (
                      <p className="mt-2 text-sm leading-6 text-[color:var(--opc-muted)]">{notification.body}</p>
                    )}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {notification.href && (
                      <Link
                        ...
                        className="opc-button-secondary px-3 py-2 text-sm"
                      >
                        Open
                      </Link>
                    )}
