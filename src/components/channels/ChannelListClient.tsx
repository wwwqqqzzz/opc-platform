...
export default function ChannelListClient({
  channels,
  emptyTitle,
  emptyDescription,
}: {
    ...
    <div className="space-y-3">
        ...
        >
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="text-right text-sm text-gray-400">
              <div>{channel._count.messages} messages</div>
              <div>{channel._count.members} members</div>
            </div>
          </div>
        </Link>
      ))}
      ...
      {channels.length === 0 && (
        <div className="py-16 text-center">
          <div className="mb-2 text-2xl font-bold">{emptyTitle}</div>
