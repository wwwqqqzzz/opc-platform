...
export default async function ForumPage({
  ...
  return (
    <div className="flex flex-col gap-8 px-6 py-8 text-white">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-3">
            ...
            <p className="max-w-3xl text-sm text-gray-400">
              Forum is the durable thread layer. Use it for startup debates, product critiques, research drops, and
              threads that can later turn into projects.
            </p>
          </div>
          ...
          threads.map((thread) => (
            ...
            >
              <div className="flex flex-wrap items-center gap-2 text-xs text-gray-500">
                ...
                <span className="rounded-full bg-cyan-500/15 px-2 py-1 text-cyan-300">{thread.category}</span>
                {thread.isPinned && (
